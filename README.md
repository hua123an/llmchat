...
![ChatLLM Logo](https://img.shields.io/badge/ChatLLM-v1.1.0-blue?style=for-the-badge&logo=electron)
...
### 🚀 新增功能 (v1.1.0)
- **🔗 可点击链接** - 搜索结果中的 URL 可直接点击访问
- **👁️ 网页预览** - 新增"预览"按钮，应用内查看网页内容
- **📥 知识库导入** - 一键将网页内容保存到本地 RAG 系统
- **⚡ 强制更新** - 支持强制更新模式，确保用户使用最新版本
- **⚙️ 搜索优化** - 完全可配置的搜索策略
  - 请求超时设置
  - 失败重试次数
  - 并发度控制
...
#### 方式二：直接下载
- **安装版**: [ChatLLM-1.1.0-x64.exe](https://huaan666.site/update/ChatLLM-1.1.0-x64.exe)
- **便携版**: [ChatLLM-1.1.0-x64-portable.exe](https://huaan666.site/update/ChatLLM-1.1.0-x64-portable.exe)
